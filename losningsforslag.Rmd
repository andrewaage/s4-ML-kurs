...
```
Selv om figurene fremstår rotete og uoversiktlige gir det god innsikt i variablene, og gir ideer om hvilke som trenger videre behandling. 
...
ads %>% 
  ...
  ggplot(aes(x = snitt_lng, y = snitt_lat, color = snitt_pris, size = snitt_pris)) + 
  geom_point() + 
  xlim(c(0,50))
```
